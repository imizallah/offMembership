...
import { updateEVP } from 'redux/actions';
...
const SuperEVP = (
    ...
    const [optionSelected,updateOptionSelected]=useState(settings.evp[0])
    ...
    useEffect(() => {
        ...
        if (settings) {
            ...
            settings.evp.map(el => {
                arr.push(
                    { value: el.amount, label: el.name, percentageProfit: el.percentageProfit,amount: el.amount }
                )
            })
        }
        updateOptions(arr);
    ...
    return (
        <>
            <div>
                <h3 className='font-weight-bold w-75' style={{ fontSize: '16px' }}>You have selected the EVP. Your required start up capital is N{optionSelected.amount}</h3>
                <h3 className='font-weight-bold w-75' style={{ fontSize: '16px' }}> You will enjoy a profit Margin of {optionSelected.percentageProfit}%.</h3>
                            ...
                            <Form encType="multipart/form-data" method="post" action="#">
                                <Card style={{ borderRadius: '20px' }}>
                                    ...
                                    <CardBody className='pt-0'>
                                        ...
                                        <Row  >
                                            <Colxx className='mt-2' xxs="12" md='12' sm='12'>
                                                <Label className='mb-0 text-muted'>Category</Label>
                                                <FormGroup className="w-100 my-1">
                                                    <Select
                                                        // isMulti
                                                        options={options}
...
export default connect(mapStateToProps, { updateEVPRequest: updateEVP })(SuperEVP);