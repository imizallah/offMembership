                        ...
                        <Card>
                            <CardBody>
                                <div className='d-flex mb-4'>
                                    <img src='../../../../assets/img/profiles/1.jpg' width='70px' height='70px' style={{ borderRadius: "20px" }} alt='evp-img' />
                                    <div className='ml-2'>
                                        <h3 className='mb-0 mt-2 font-weight-bold'>James Mustafa</h3>
                                    ...
                                    <div xl='3' md='6'>
                                        <div className='d-flex'>
                                            <div className='text-center mt-2 pt-2' style={{
                                                ...
                                                <FaPhoneAlt size='1px' color='#922C88' />
                                            </div>
                                            <div className='ml-2'>
                                                <p className='mb-0 mt-2'>Telephone</p>
                                                <p className='font-family-m font-weight-bold'>021 2346 664</p>
                                            </div>
                                        </div>
                                    ...
                                    <div xl='3' md='6'>
                                        <div className='d-flex'>
                                            ...
                                            <div className='ml-2'>
                                                ...
                                                <p className='font-family-m font-weight-bold'>N56,000</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className='d-flex'>
                                            ...
                                            <div className='ml-2'>
                                                ...
                                                <p className='font-family-m font-weight-bold'>Abuja, Nigeria</p>
                                            </div>
                                        </div>
