...
import { createUser, verifyUser,createAdvertiser } from 'redux/actions';
                    ...
                    <Formik initialValues={registerValues} onSubmit={(e) => { handleMemberShipCreation(e) }}>
                        {({ errors, touched }) => (
                            <Form encType="multipart/form-data" method="post" action="#">
                                <Card style={{ borderRadius: '20px' }}>
                                    <div className='my-3 '>
                                        <h1 className='mb-0 pl-4 pb-0 font-family-m font-weight-bold' style={{ fontSize: '20px' }}>EmAds Membership</h1>
                                        <Separator />
                                    </div>
                                    <CardBody className='pt-0'>
...
export default connect(mapStateToProps, {
    ...
    createAdvertiserAction: createAdvertiser
